        ...
        <div className={cn("relative w-full h-full", className)}>
            ...
            */}
            <div
                ...
                className={cn(
                    "relative z-10 bg-white border-4 border-secondary p-6 shadow-neo cursor-grab active:cursor-grabbing select-none h-full flex flex-col justify-between overflow-hidden transition-[background-color]",
            ...
            >
                <div>
                    ...
                    <div className="flex justify-between items-start mb-4">
                        ...
                        <div className="w-8 h-8 bg-secondary border-2 border-secondary rounded-full flex-shrink-0" />
                    </div>
                    {/* Body */}
                    <p className="font-bold text-lg leading-tight">{description}</p>
                </div>
                {/* Footer */}
                <div className="mt-8 border-t-2 border-secondary pt-2 flex justify-between text-xs font-mono uppercase">
