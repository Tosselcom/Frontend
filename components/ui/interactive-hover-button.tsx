...
>(({ text = "Button", className, ...props }, ref) => {
  return (
    ...
    >
      ...
      <div className="absolute left-[8%] top-1/2 z-0 h-2 w-2 -translate-y-1/2 scale-[1] rounded-lg bg-primary transition-all duration-300 group-hover:left-[0%] group-hover:top-[0%] group-hover:h-full group-hover:w-full group-hover:translate-y-0 group-hover:scale-[1.8] group-hover:bg-primary"></div>
    </button>
  );
});
